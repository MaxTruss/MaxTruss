...
int main(int argc, char *argv[])
{
    ...
    while (0 < iRemainBgt)
    {
        ...
        oDesComp.m_iRandomMax = iRandomMax;
        ...
        else
        {
            ...
            gettimeofday(&tv, NULL);
            lStartTime = tv.tv_sec * 1000 + tv.tv_usec / 1000;
            int iGroupNum = oDesComp.tableRandom();
            gettimeofday(&tv, NULL);
            lCurTime = tv.tv_sec * 1000 + tv.tv_usec / 1000;
            ...
            {
                iTotalScore += oDesComp.largeDPTable(vCurCanE, true);
            }
            gettimeofday(&tv, NULL);
            lCurTime = tv.tv_sec * 1000 + tv.tv_usec / 1000;
